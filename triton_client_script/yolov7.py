...
class _YoloV7ClientOnly:
    """
    http://git.graymatics.com/kelvin/yolov7_all_triton/src/branch/master/yolov7_client_script/yolov7_client.py
    A client to interact with a YOLOv7 model deployed on Triton Inference Server.
    """
    def __init__(self, name="yolov7", url="172.17.0.1:8001", width=640, height=640):
    ...
    def _detect_only(self, frame):
        ...
        detected_objects = self._yolov7_postprocess(results)
        return detected_objects



    ### ===================================================================================
    # internal utils (please change _yolov7_postprocess not yolov7)
    ...
    def _yolov7_postprocess(self, results, letter_box=True):
...
class YoloV7ClientTracker(_YoloV7ClientOnly):
    """
    Extension of YoloV7Client with object tracking capabilities.
    """
...
if __name__ == "__main__":
    yolo = YoloV7ClientTracker(name="yolov7", url="172.17.0.1:12001", width=640, height=640)
